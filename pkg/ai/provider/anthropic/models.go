...
var (
	ClaudeFable5 = ai.Model{
		...
		Limits:           ai.Limits{Context: 1000000, Output: 128000},
	...
	ClaudeHaiku45 = ai.Model{
		...
		Input:            []ai.Modality{ai.ModalityText, ai.ModalityImage, ai.ModalityPDF},
		Output:           []ai.Modality{ai.ModalityText},
		Limits:           ai.Limits{Context: 200000, Output: 64000},
	...
	ClaudeOpus41 = ai.Model{
		...
		Input:            []ai.Modality{ai.ModalityText, ai.ModalityImage, ai.ModalityPDF},
		Output:           []ai.Modality{ai.ModalityText},
		Limits:           ai.Limits{Context: 200000, Output: 32000},
		ContextWindow:    200000,
		MaxTokens:        32000,
	...
	ClaudeSonnet45 = ai.Model{
		...
		Input:            []ai.Modality{ai.ModalityText, ai.ModalityImage, ai.ModalityPDF},
		Output:           []ai.Modality{ai.ModalityText},
		Limits:           ai.Limits{Context: 1000000, Output: 64000},
		ContextWindow:    1000000,
		MaxTokens:        64000,
