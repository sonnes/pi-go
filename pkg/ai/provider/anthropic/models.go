...
var (
	ClaudeFable5 = ai.Model{
		...
		Name:                 "Claude Fable 5",
		Reasoning:            true,
		ThinkingLevels:       []ai.ThinkingLevel{ai.ThinkingLow, ai.ThinkingMedium, ai.ThinkingHigh, ai.ThinkingXHigh, ai.ThinkingMax},
	...
	ClaudeOpus46 = ai.Model{
		...
		Reasoning:            true,
		ThinkingLevels:       []ai.ThinkingLevel{ai.ThinkingLow, ai.ThinkingMedium, ai.ThinkingHigh, ai.ThinkingMax},
		DefaultThinkingLevel: ai.ThinkingHigh,
		ToolCall:             true,
		StructuredOutput:     true,
		Temperature:          true,
