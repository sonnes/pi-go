.PHONY: test test-pkg check fmt modernize tidy run build install gen \
...
modernize:
	go fix ./...
	go fix ./pkg/agent/claude/...
	go fix ./pkg/agent/codex/...
	go fix ./pkg/agent/cursor/...
	go fix ./pkg/ai/provider/anthropic/...
	go fix ./pkg/ai/provider/claudecli/...
	go fix ./pkg/ai/provider/codexcli/...
	go fix ./pkg/ai/provider/cursorcli/...
	go fix ./pkg/ai/provider/google/...
	go fix ./pkg/ai/provider/openai/...
	go fix ./pkg/ai/provider/openairesponses/...
	go fix ./pkg/pi/...
	go fix ./pkg/tool/find/...
	go fix ./pkg/tool/grep/...
	go fix ./cmd/pi/...
	go fix ./cmd/piwasm/...
